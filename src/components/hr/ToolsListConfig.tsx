...
import type { Organization, IssuedTool, MasterToolsList, MasterTool } from '../../types/mindmesh';
    ...
    useEffect(() => {
        ...
        Promise.all([api.getOrganizations(), api.getAllSiteIssuedTools(), api.getToolsList()])
            .then(([sitesData, issuedToolsData, masterToolsData]) => {
                const sortedSites = sitesData ? sitesData.sort((a: Organization, b: Organization) => a.shortName.localeCompare(b.shortName)) : [];
