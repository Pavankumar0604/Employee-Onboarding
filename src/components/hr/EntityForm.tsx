...
import type { Entity, RegistrationType, Policy, Insurance } from '../../types/mindmesh';
...
const entitySchema = yup.object({
  ...
  insuranceIds: yup.array(yup.string()).optional(),
  policyIds: yup.array(yup.string()).optional(),
}).defined();
