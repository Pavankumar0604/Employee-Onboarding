...
const SelectOrganization: React.FC = () => {
        ...
        return (
            <div className="h-full flex flex-col bg-background">
                <header className="p-4 flex-shrink-0 flex items-center gap-4 fo-mobile-header border-b border-border/50">
                    ...
                    <h1 className="text-heading-l font-semibold text-primary-text">New Enrollment</h1>
                </header>
                <main className="flex-1 overflow-y-auto p-5">
                    <div className="bg-card rounded-2xl p-6 space-y-6 shadow-lg">
                        <div className="text-center">
                            ...
                            <h2 className="text-heading-l font-extrabold text-primary-text">Select Site & Role</h2>
                            <p className="text-body-small text-muted-foreground mt-1">Choose the client, site, and designation for the new employee.</p>
                        </div>
    ...
    return (
        <div className="p-4 md:p-8">
            <div className="bg-card p-6 rounded-xl shadow-lg w-full max-w-5xl mx-auto">
                ...
                <div className="text-center mb-6">
                    ...
                    <h2 className="text-heading-xl text-primary-text">Select Site</h2>
                    <p className="text-body-small text-muted-foreground mt-1">Choose the client and site for the new employee.</p>
                </div>
