...
import type { LeaveRequest, LeaveRequestStatus } from '../../types/mindmesh';
            ...
            if (request.status === 'pending_manager_approval') {
                return (
                    <div className="flex gap-2">
                        <Button size="sm" variant="icon" onClick={() => handleAction(request.id, 'approve')} disabled={actioningId === request.id} title="Approve" aria-label="Approve request"><Check className="h-4 w-4 text-sky-700" /></Button>
                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-border">
                        <thead className="bg-page">
                            <tr>
                                <th className="px-4 py-3 text-left text-label uppercase">Employee</th>
                                <th className="px-4 py-3 text-left text-label uppercase">Type</th>
                                <th className="px-4 py-3 text-left text-label uppercase">Dates</th>
                                <th className="px-4 py-3 text-left text-label uppercase">Reason</th>
                                <th className="px-4 py-3 text-left text-label uppercase">Status</th>
                                <th className="px-4 py-3 text-left text-label uppercase">Actions</th>
                            </tr>
                        </thead>
