...
const TaskBoardPage: React.FC = () => {
 ...
 return (
   <div className="p-6 space-y-4">
     <h1 className="text-2xl font-bold text-primary-text mb-4">Support Desk - Kanban Board</h1>

     <div className="flex">
       <div className="w-1/3 p-4">
         <h2 className="text-xl font-semibold text-primary-text mb-2">Open</h2>
         {/* Droppable Area - Open */}
         <div>
           {openTasks.map(task => (
       ...
       <div className="w-1/3 p-4">
         <h2 className="text-xl font-semibold text-primary-text mb-2">In Progress</h2>
       ...
       <div className="w-1/3 p-4">
         <h2 className="text-xl font-semibold text-primary-text mb-2">Completed</h2>
