    ...
    <div className="fixed top-0 left-0 w-full h-full bg-black/50 flex items-center justify-center z-50" onClick={onClose}>
      <div className="bg-white rounded-xl shadow-lg p-6 max-w-2xl mx-auto" onClick={(e: React.MouseEvent) => e.stopPropagation()}>
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold text-primary-text">Task Details</h2>
            ...
            {isEditing ? (
              ...
              <>
                ...
                <div className="border-t border-primary-border pt-4">
                  <h4 className="text-lg font-semibold text-primary-text">Escalation Workflow</h4>
                  <p className="text-sm text-primary-text/70">[Escalation rules and actions would be displayed here]</p>
                </div>

                {/* Placeholder for Real-time Notifications */}
                <div className="border-t border-primary-border pt-4">
                  <h4 className="text-lg font-semibold text-primary-text">Real-time Notifications</h4>
                  <p className="text-sm text-primary-text/70">[Real-time notifications related to this task would appear here]</p>
                </div>

                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-sm text-primary-text/70">Assigned to: [User Name]</p>
                    <p className="text-sm text-primary-text/70">Due Date: [Due Date]</p>
                  </div>
