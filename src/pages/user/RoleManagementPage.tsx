...
import type { UserRole, Permission } from '../../types/mindmesh';
...
const allRoles: UserRole[] = ['admin', 'hr', 'developer', 'operation_manager', 'site_manager', 'field_officer', 'guest'];
    ...
    return (
        <div className="bg-card p-6 sm:p-8 rounded-xl shadow-card">
            ...
            <p className="text-muted text-sm -mt-4 mb-6">
                Assign permissions to user roles. Changes are saved automatically. <span className="font-semibold text-red-600"> <br /> Warning:</span> Modifying the Admin role can lead to being locked out of system features.
            </p>
